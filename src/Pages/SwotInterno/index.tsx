...
interface FormData {
  ...
  descricao3: string;
  fraqueza1: string;
  fraqueza1_descricao: string;
  fraqueza2: string;
  fraqueza2_descricao: string;
  fraqueza3: string;
  fraqueza3_descricao: string;
}
...
const Missao: FC = () => {
  ...
  const handleSubmit = useCallback(async (data: FormData) => {
    ...
    localStorage.setItem('@StrategyFactory:swot-interno', JSON.stringify(data));

    history.push('/swot-externo');
  }, []);

  useEffect(() => {
    const dados = localStorage.getItem('@StrategyFactory:swot-interno');
  ...
  return (
    <BodyContent>
      ...
      <Container>
        <div>
          <Title>Análise SWOT – Ambiente Interno</Title>
        ...
        <Box w="80%" textAlign="left">
          <Text top="10px" textAlign="left">
            Nesta etapa será feita uma reflexão sobre os impactos positivos e os
            impactos negativos de fatores internos e externos no desempenho da
            empresa. Realizar um diagnóstico é um importante pré-requisito para
        ...
        <Box w="80%" textAlign="left">
          <Text textAlign="left">
            Vamos iniciar pelo <b>ambiente</b> interno da empresa:
          </Text>
        </Box>

        <Box w="80%" textAlign="left">
          <Text textAlign="left">
            Liste as principais FORÇAS INTERNAS que a empresa possui hoje, que a
            tornam positivamente diferenciada:
          </Text>
        </Box>
        ...
        <Box w="80%" top="25px" textAlign="left">
          <Form ref={FormRef} onSubmit={handleSubmit}>
            ...
            <Box w="100%" top="50px" textAlign="left">
              <Text textAlign="left">
                Agora liste as principais FRAQUEZAS INTERNAS que a empresa
                possui hoje, e que precisam ser eliminadas:
              </Text>
            </Box>
